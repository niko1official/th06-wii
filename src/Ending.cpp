    ...
    while (true)
    {
        ...
        case END_READ_OPCODE:
            ...
            case END_OPCODE_SCROLL_BACKGROUND:
                ...
                this->endFileDataPtr++;
                scrollBGDistance = this->ReadEndFileParameter();
                scrollBGDuration = this->ReadEndFileParameter();
            ...
            case END_OPCODE_SET_VERTICAL_SCROLL_POS:
                ...
                this->backgroundPos.y = this->ReadEndFileParameter();
                break;
            ...
            case END_OPCODE_WAIT_RESET:
                ...
                this->endFileDataPtr++;
                this->timer3.SetCurrent(this->ReadEndFileParameter());
            ...
            case END_OPCODE_WAIT:
                ...
                this->endFileDataPtr++;
                this->timer2.SetCurrent(this->ReadEndFileParameter());
            ...
            case END_OPCODE_FADE_IN_BLACK:
                ...
                this->timeFading = 0;
                this->fadeFrames = this->ReadEndFileParameter();
                break;
